...
const array = ['Karayanda','Killadi','Engane','Muthe','Ithaara','Mood','Vibe','Hate','heppie','Ariyoo','Committed','Aliya','Paavam','Alone','sad','da','Nthaada','aara','kozhi','love','aada','myr','Thantha']
array.map( async (a) => {
